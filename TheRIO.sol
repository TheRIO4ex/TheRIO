...
contract TheRio is Context, IBEP20, Ownable {
    ...
    address private _marketingWalletAddress = 0x93a5cdb0119caA0B4EDF5993b01eD97947288f21;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 31979000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "The RIO";
    string private _symbol = "DRIO";
